...
const faqs = [
  ...
  {
    category: "system",
    question: "放課後等デイは「不登校」でも利用できますか？",
    answer: "はい、利用できます。不登校自体が理由ではなく、発達面の継続的な支援ニーズがある場合が対象です。感覚過敏、対人不安、生活リズムの大きな乱れなどがある場合、受給者証の対象となる可能性があります。まずは見立て（アセスメント）で状況を整理し、必要に応じて医療機関や相談支援事業所につなぎます。",
  },
  {
    category: "system",
    question: "実費の学習支援と放課後等デイは併用できますか？",
    answer: "はい、併用可能です。放課後等デイサービスは週2〜3回利用し、それ以外の日に実費のAI学習や受験個別を利用するケースもあります。お子さまの状況と目標に応じて、最適な組み合わせをご提案します。ただし、同一時間帯での利用はできません。",
  },
  {
    category: "system",
    question: "受給者証の取得にはどのくらい時間がかかりますか？",
    answer: "自治体により異なりますが、申請から交付まで通常2〜4週間程度です。医師の意見書が必要な場合は、診察予約から含めると1〜2ヶ月かかることもあります。当センターでは申請プロセスのサポートも行っていますので、お気軽にご相談ください。",
  },
  {
    category: "system",
    question: "放課後等デイの利用に年齢制限はありますか？",
    answer: "放課後等デイサービスは原則として6歳〜18歳（小学校入学〜高校卒業）までが対象です。ただし、18歳以降も引き続き支援が必要と認められる場合は、20歳まで利用可能な場合があります。詳しくは自治体の窓口にご確認ください。",
  },
  {
    category: "system",
    question: "放課後等デイでオンライン（遠隔）支援はできますか？",
    answer: "できません。放課後等デイは通所による支援のみ提供します。オンラインでの学習支援は制度対象外（実費）としてご案内します。",
  },
  {
    category: "system",
    question: "放課後等デイと実費のオンライン支援は併用できますか？",
    answer: "併用可能です。ただし別契約・別請求となります。個別支援計画には通所内の活動のみ記載します。",
  },
];
